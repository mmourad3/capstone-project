...
export const initializeDemoUsers = () => {
  const demoUsers = [
    {
      ...
      questionnaire: {
        ...
        personalQualities: ['Respectful', 'Honest', 'Communicative', 'Reliable'],
    ...
    },
    {
      ...
      picture: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400',
      phone: '+9611234568',
      country: 'Lebanon',
      gender: 'female',
      role: 'dorm-seeker',
      questionnaire: {
        ...
        personalQualities: ['Friendly', 'Easygoing', 'Communicative', 'Adaptable'],
    ...
    },
    {
      ...
      questionnaire: {
        ...
        personalQualities: ['Respectful', 'Reliable', 'Communicative', 'Honest'],
  ...
  demoUsers.forEach(demoUser => {
    const exists = registeredUsers.some(user => user.email === demoUser.email);
